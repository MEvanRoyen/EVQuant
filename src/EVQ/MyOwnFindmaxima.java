 ...
 *
 * Adapted for EVQuant analysis by Johan Slotman ErasmusMC Optical Imaging Centre
 */

public class MyOwnFindmaxima implements ExtendedPlugInFilter, DialogListener {
    //filter params
    ...
    public Polygon   xyCoordinates;                // maxima found by findMaxima() POINT_SELECTION, LIST, COUNT
     ...
     */
    public Integer findMaxima(ImageProcessor ip, double tolerance, int outputType, boolean excludeOnEdges) {
     ...
     *                       Returns null if outputType does not require an output or if cancelled by escape
     */
    public Integer findMaxima(ImageProcessor ip, double tolerance, double threshold,
     ...
     *                       Returns null if outputType does not require an output or if cancelled by escape
     */
    public Integer findMaxima(ImageProcessor ip, double tolerance, boolean strict, double threshold,
                                    int outputType, boolean excludeOnEdges, boolean isEDM) {
